...
const navItems = [
  { path: '/hr', icon: LayoutDashboard, label: 'Dashboard', end: true },
  { path: '/hr/assessments', icon: ClipboardList, label: 'Assessments' },
  { path: '/hr/candidates', icon: Users, label: 'Candidates' },
  { path: '/hr/resumes', icon: FileText, label: 'Resumes' },
  { path: '/hr/analytics', icon: BarChart3, label: 'Analytics' },
];
